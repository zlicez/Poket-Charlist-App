...
- Искать заклинания в библиотеке по названию, уровню и школе.
...
- Фильтр заклинаний по классам пока не реализован.
- Email verification и reset пароля через почту пока отсутствуют.
- Компонент `ConnectionStatus` существует, но сейчас не смонтирован в основном UI.

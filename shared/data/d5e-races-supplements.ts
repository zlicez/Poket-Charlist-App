...
export const SUPPLEMENT_RACES: Record<string, RaceDefinition> = {
  ...
  "Грибнит": {
    ...
    entityType: "race",
    size: "Medium",
    creatureType: "Растение",
    abilityBonuses: { DEX: 2, CON: 1 },
    speed: 30,
    darkvision: 60,
    description:
      "Грибниты — разумные грибоподобные существа, рождённые в подземных лесах и влажных пещерах. " +
      "Их тела покрыты шляпкой-куполом, а споры служат как средством общения, так и защиты. " +
      "Грибниты живут небольшими колониями и обладают врождённой связью с миром грибков и плесени.",
    traits: [
      "Споровый выброс: как действие (1×/короткий отдых) выпускаете облако спор в радиусе 10 фт. — все существа должны пройти спасбросок Телосложения СЛ 8 + бонус мастерства + мод. Тел или получить отравление до конца своего следующего хода",
      "Грибковое чутьё: преимущество на проверки Выживания для поиска пути под землёй и в лесах",
      "Устойчивость к яду: преимущество на спасброски против отравления",
      "Природная маскировка: преимущество на проверки Скрытности в лесистой или пещерной местности",
    ],
